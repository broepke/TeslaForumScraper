...
Techniques in this notebook were built off of the learnings from the Data Camp course on Web Scraping with R.  This includes throughout the work the guidance to "Be Kind" with the web servers. Therefore it includes multiple delays before each scraping call to pages using the `slowly` function from `purrr`.  
...
```{r}
page_urls <- c(paste0("https://forums.tesla.com/categories/tesla-model-3/p", 1:50))
